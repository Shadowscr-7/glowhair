            ...
            <div className="mt-6">
              ...
              <div className="mt-6">
                ...
                <motion.button
                  ...
                  type="button"
                  disabled={isSubmitting || isLoading}
                  className="w-full inline-flex justify-center items-center py-3 px-4 border border-gray-300 rounded-lg bg-white text-sm font-medium text-gray-700 hover:bg-gray-50 transition-colors disabled:opacity-50 gap-2"
                >
                ...
                {/* Facebook - Comentado para configuración futura */}
                {/* 
                <motion.button
                  whileHover={{ scale: 1.02 }}
                  whileTap={{ scale: 0.98 }}
                ...
                */}
                ...
                {/* Instagram - Comentado para configuración futura */}
                {/* 
                <motion.button
                  whileHover={{ scale: 1.02 }}
                  whileTap={{ scale: 0.98 }}
