...
const AdminLayout = ({ children }: AdminLayoutProps) => {
  ...
  const navigation = [
    ...
    { name: "Pedidos Recientes", href: "/admin/pedidos", icon: ShoppingCart },
    { name: "Productos Más Vendidos", href: "/admin/productos-vendidos", icon: TrendingUp },
          ...
          <div className="flex flex-col h-full pt-16"> {/* Add padding-top for navbar space */}
                    ...
                    <Link key={item.name} href={item.href}>
                      <motion.div
                        ...
                        className={`flex items-center px-3 py-2 text-sm font-medium rounded-lg transition-colors ${
                          isActive
                            ? "bg-glow-50 text-glow-700 border-r-2 border-glow-600"
            ...
            <div className="px-6 py-4 border-t border-gray-200">
              <div className="flex items-center space-x-3">
                <div className="w-8 h-8 bg-gradient-to-br from-glow-400 to-glow-600 rounded-full flex items-center justify-center">
